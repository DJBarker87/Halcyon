  ...
  cat > "${CONFIG_DIR}/regression_keeper.json" <<EOF
{
  ...
  "spy_history_source": "${REGRESSION_SPY_HISTORY_SOURCE:-pyth:SPY_USD}",
  "qqq_history_source": "${REGRESSION_QQQ_HISTORY_SOURCE:-pyth:QQQ_USD}",
  "iwm_history_source": "${REGRESSION_IWM_HISTORY_SOURCE:-pyth:IWM_USD}",
  "pyth_benchmarks_base_url": "${REGRESSION_PYTH_BENCHMARKS_BASE_URL:-https://benchmarks.pyth.network}",
  "history_cache_dir": "${REGRESSION_HISTORY_CACHE_DIR:-/var/lib/halcyon/pyth-history}",
