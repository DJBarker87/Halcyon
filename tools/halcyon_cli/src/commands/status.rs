...
pub async fn run(ctx: &CliContext) -> Result<()> {
    ...
    println!(
        "protocol: admin={} issuance_paused={} settlement_paused={} utilization_cap_bps={} sigma_floor_annualised_s6={}",
    ...
    println!(
        "keepers: observation={} hedge={} regime={}",
        keeper_registry.observation, keeper_registry.hedge, keeper_registry.regime
    );
    println!(
